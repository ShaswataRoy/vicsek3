...
const long long int N=60;
int steps=10000, near_count;
int time_max = 100;
double x[N], y[N], vx[N], vy[N], theta[N], t[N], theta_avg=0.;
double L=3.87,vc=0.3, dt=1, sigma=0.15, r=1,eta=0.,lambda = 0.1;
